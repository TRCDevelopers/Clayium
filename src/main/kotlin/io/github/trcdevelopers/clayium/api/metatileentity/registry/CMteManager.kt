package io.github.trcdevelopers.clayium.api.metatileentity.registry
...
class CMteManager {
     ...
     * If you need a safe version, use [getRegistrySafe].
     * @throws IllegalArgumentException If MTE registry for `modId` is not found.
     */
