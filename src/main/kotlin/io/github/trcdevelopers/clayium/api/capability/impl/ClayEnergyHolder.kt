...
import io.github.trcdevelopers.clayium.api.block.IEnergyStorageUpgradeBlock
...
class ClayEnergyHolder(
    ...
    fun createCeTextWidget(syncManager: PanelSyncManager): TextWidget<*> {
        ...
        return IKey.dynamic { this.clayEnergy.formatWithTrailingZerosAndUnit() }.asWidget()
            .width(60)
    }
