...
import io.github.trcdevelopers.clayium.common.blocks.marker.ClayMarkerType
...
object AssemblerRecipeLoader {
    fun registerRecipes() {
        ...
        registry.builder()
            ...
            .buildAndRegister()
        registry.builder()
            .input(OrePrefix.ingot, CMaterials.az91d, 16)
            .input(MetaItemClayParts.PrecisionCircuit)
            .output(MetaItemClayParts.ManipulatorMk1)
            .tier(4).CEt(ClayEnergy.milli(1)).duration(20)
            .buildAndRegister()
        registry.builder()
            .input(MetaItemClayParts.ManipulatorMk1, 16)
            .input(MetaItemClayParts.ClayCore, 6)
            .output(MetaItemClayParts.ManipulatorMk2)
            .tier(4).CEt(ClayEnergy.of(10)).duration(20)
            .buildAndRegister()
        registry.builder()
            .input(MetaItemClayParts.ManipulatorMk2, 64)
            .input(MetaItemClayParts.ClayAnima, 6)
            .output(MetaItemClayParts.ManipulatorMk3)
            .tier(10).CEt(ClayEnergy.of(100_000)).duration(20)
            .buildAndRegister()
        //endregion
        ...
        registry.builder()
            ...
            .output(ClayiumItems.CLAY_GUN)
            .tier(4).CEt(ClayEnergy.milli(1)).duration(40)
            .buildAndRegister()
        registry.builder()
            .input(OrePrefix.plate, CMaterials.az91d, 4)
            .input(MetaItemClayParts.AdvancedCircuit)
            .output(ClayiumItems.CLAY_GUN_ADVANCED)
            .tier(4).CEt(ClayEnergy.milli(10)).duration(40)
            .buildAndRegister()
        registry.builder()
            .input(OrePrefix.plate, CMaterials.az91d, 4)
            .input(MetaItemClayParts.PrecisionCircuit)
            .output(ClayiumItems.CLAY_SNIPER)
            .tier(4).CEt(ClayEnergy.milli(100)).duration(40)
            .buildAndRegister()
        registry.builder()
            .input(OrePrefix.plate, CMaterials.az91d, 4)
            .input(MetaItemClayParts.IntegratedCircuit)
            .output(ClayiumItems.CLAY_SNIPER_PRO)
            .tier(4).CEt(ClayEnergy.of(1)).duration(40)
            .buildAndRegister()
    }
}