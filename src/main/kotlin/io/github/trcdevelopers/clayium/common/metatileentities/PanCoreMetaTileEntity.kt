...
import io.github.trcdevelopers.clayium.api.capability.ClayiumDataCodecs.UPDATE_PAN_DUPLICATION_ENTRIES
...
import io.github.trcdevelopers.clayium.api.pan.isPanCable
import io.github.trcdevelopers.clayium.api.readClayEnergy
...
import io.github.trcdevelopers.clayium.api.unification.stack.readItemAndMeta
import io.github.trcdevelopers.clayium.api.unification.stack.writeItemAndMeta
import io.github.trcdevelopers.clayium.api.util.ITier
import io.github.trcdevelopers.clayium.api.util.clayiumId
import io.github.trcdevelopers.clayium.api.writeClayEnergy
...
class PanCoreMetaTileEntity(
    ...
    tier: ITier,
) : MetaTileEntity(metaTileEntityId, tier, onlyNoneList, onlyNoneList, "pan_core"), IPan {
        ...
        val displayItems = Grid.mapToMatrix(9, duplicationEntries.toList()) { index, (itemAndMeta, entry) ->
            ...
            ItemDrawable(stack).asWidget().size(16)
                .tooltip { tooltip ->
                    ...
                    tooltip.add(entry.ce.formatNoExcessZero())
                }
                .also {
