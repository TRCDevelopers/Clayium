...
import io.github.trcdevelopers.clayium.api.unification.material.Clay
...
class ClayFabricatorMetaTileEntity(
    ...
    override fun buildMainParentWidget(syncManager: PanelSyncManager): ParentWidget<*> {
        ...
        return super.buildMainParentWidget(syncManager)
            ...
            .child(IKey.dynamic { workable.currentCe.formatWithTrailingZerosAndUnit() }.asWidget().width(60)
                .left(0).bottom(10))
    }
