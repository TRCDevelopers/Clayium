...
import io.github.trcdevelopers.clayium.common.recipe.builder.SimpleRecipeBuilder
...
object CRecipes {
    ...
    val ENERGETIC_CLAY_DECOMPOSER = addRegistry("energetic_clay_decomposer", SimpleRecipeBuilder(), 1, 1)
