...
object ClayGuiTextures {
    ...
    val SLOT_M1: UITexture = slotTexture().uv(32, 96, 18, 18).build()
    val SLOT_M2: UITexture = slotTexture().uv(64, 96, 18, 18).build()
    val SLOT_M3: UITexture = slotTexture().uv(96, 96, 18, 18).build()
    val SLOT_M4: UITexture = slotTexture().uv(128, 96, 18, 18).build()
    val SLOT_M5: UITexture = slotTexture().uv(160, 96, 18, 18).build()
    val SLOT_M6: UITexture = slotTexture().uv(192, 96, 18, 18).build()

    val M_TRACK_SLOTS = arrayOf(SLOT_M1, SLOT_M2, SLOT_M3, SLOT_M4, SLOT_M5, SLOT_M6)

    val FILTER_SLOT_M1: UITexture = slotTexture().uv(32, 128, 18, 18).build()
    val FILTER_SLOT_M2: UITexture = slotTexture().uv(64, 128, 18, 18).build()
    val FILTER_SLOT_M3: UITexture = slotTexture().uv(96, 128, 18, 18).build()
    val FILTER_SLOT_M4: UITexture = slotTexture().uv(128, 128, 18, 18).build()
    val FILTER_SLOT_M5: UITexture = slotTexture().uv(160, 128, 18, 18).build()
    val FILTER_SLOT_M6: UITexture = slotTexture().uv(192, 128, 18, 18).build()
