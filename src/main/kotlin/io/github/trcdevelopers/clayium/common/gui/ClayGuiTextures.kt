...
object ClayGuiTextures {
    ...
    val SLOT_M1 = slotTexture().xy(32, 96, 18, 18).build()
    val SLOT_M2 = slotTexture().xy(64, 96, 18, 18).build()
    val SLOT_M3 = slotTexture().xy(96, 96, 18, 18).build()
    val SLOT_M4 = slotTexture().xy(128, 96, 18, 18).build()
    val SLOT_M5 = slotTexture().xy(160, 96, 18, 18).build()
    val SLOT_M6 = slotTexture().xy(192, 96, 18, 18).build()

    val M_TRACK_SLOTS = arrayOf(SLOT_M1, SLOT_M2, SLOT_M3, SLOT_M4, SLOT_M5, SLOT_M6)

    val FILTER_SLOT_M1 = slotTexture().xy(32, 128, 18, 18).build()
    val FILTER_SLOT_M2 = slotTexture().xy(64, 128, 18, 18).build()
    val FILTER_SLOT_M3 = slotTexture().xy(96, 128, 18, 18).build()
    val FILTER_SLOT_M4 = slotTexture().xy(128, 128, 18, 18).build()
    val FILTER_SLOT_M5 = slotTexture().xy(160, 128, 18, 18).build()
    val FILTER_SLOT_M6 = slotTexture().xy(192, 128, 18, 18).build()
