package io.github.trcdevelopers.clayium.common.blocks.chunkloader
...
class ChunkLoaderTileEntity : TileEntity() {
    ...
    fun requestTicket(): ForgeChunkManager.Ticket? {
        val ticket = ForgeChunkManager.requestTicket(ClayiumMod, this.world, ForgeChunkManager.Type.NORMAL)
        if (ticket == null) {
            CLog.warn("Chunk Loader at $pos failed to request a new ticket. There are too many $MOD_NAME's Chunk Loaders in the world.")
            return null
        }
