...
abstract class BlockSingleSlotMachine : BlockContainer(Material.IRON) {
    ...
    override fun getExtendedState(state: IBlockState, world: IBlockAccess, pos: BlockPos): IBlockState {
        val ext = state as IExtendedBlockState
        val tile = world.getTileEntity(pos) as? TileSingleSlotMachine ?: return ext

        Clayium.LOGGER.info("Extended state called. ${tile.inputUp}")
