...
import com.github.trcdevelopers.clayium.common.items.ClayiumItems.getRarity
...
class CompressedClay private constructor(materialIn: Material, tier: Int, ce: Long, registryName: String) : Block(materialIn),
    IEnergizedClay {
    companion object {
