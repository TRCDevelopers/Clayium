...
object CaInjectorRecipeLoader {
    fun registerRecipes() {
        ...
        registry
            ...
            .input(OrePrefix.gem, CMaterials.antimatter, 8)
            .output(
                ClayiumBlocks.ENERGY_STORAGE_UPGRADE.getItem(
                    BlockCaReactorCoil.BlockType.ANTIMATTER
                )
            )
            .tier(9)
            .CEtFactor(2.0)
        ...
        registry
            ...
            .output(
                ClayiumBlocks.ENERGY_STORAGE_UPGRADE.getItem(
                    BlockCaReactorCoil.BlockType.PURE_ANTIMATTER
                )
            )
            .tier(11)
            .CEtFactor(2.0)
        ...
        registry
            .builder()
            .input(
                ClayiumBlocks.ENERGY_STORAGE_UPGRADE.getItem(BlockCaReactorCoil.BlockType.OEC, 16)
            )
            .input(OrePrefix.gem, CMaterials.antimatter, 64)
        ...
        for (mteList in MetaTileEntities.mteLists) {
            for ((prev, next) in mteList.windowed(2)) {
                ...
                val antimatterAmount =
                    ((prevTier + 1)..recipeTier)
                        .sumOf { CaInjectorMetaTileEntity.ANTIMATTER_AMOUNTS[it - 2] }
                        .coerceAtMost(64)
