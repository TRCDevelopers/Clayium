...
interface IOreDictUnifier {
    ...
    fun get(orePrefix: OrePrefix, material: IMaterial, amount: Int = 1) =
        get(UnificationEntry(orePrefix, material).toString(), amount)

    fun getAll(oreDict: String, amount: Int = 1): List<ItemStack>

    fun getAll(orePrefix: OrePrefix, material: IMaterial, amount: Int = 1) =
        getAll(UnificationEntry(orePrefix, material), amount)
    ...
    fun exists(orePrefix: OrePrefix, material: IMaterial): Boolean =
        exists(UnificationEntry(orePrefix, material).toString())
}
