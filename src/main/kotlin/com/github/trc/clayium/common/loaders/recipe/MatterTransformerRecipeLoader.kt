...
object MatterTransformerRecipeLoader {
    ...
    private fun getLeaveStack(type: BlockPlanks.EnumType): ItemStack {
        val meta = type.metadata
        val block =
            if (type in BlockOldLeaf.VARIANT.allowedValues) Blocks.LEAVES else Blocks.LEAVES2
    ...
    private fun registerMaterialTransformations() {
        CRecipes.MATTER_TRANSFORMER.builder()
            ...
            .CEtFactor(10.0)
            .duration(200)
            .chain(CMaterials.potassium)
            .CEtFactor(30.0)
            .chain(CMaterials.rubidium)
            .tier(8)
            .CEtFactor(10.0)
            .chain(CMaterials.caesium)
            .CEtFactor(20.0)
            .chain(CMaterials.francium)
            .CEtFactor(30.0)
            .chain(CMaterials.radium)
            .CEtFactor(50.0)
            .chain(CMaterials.actinium)
            .tier(9)
            .CEtFactor(10.0)
            .chain(CMaterials.thorium)
            .CEtFactor(20.0)
            .chain(CMaterials.protactinium)
            .CEtFactor(30.0)
            .chain(CMaterials.uranium)
            .CEtFactor(50.0)
            .chain(CMaterials.neptunium)
            .CEtFactor(80.0)
            .chain(CMaterials.plutonium)
            .tier(10)
            .CEtFactor(20.0)
            .chain(CMaterials.americium)
            .tier(11)
            .CEtFactor(30.0)
            .chain(CMaterials.curium)
            .tier(12)
            .CEtFactor(50.0)
            .buildAndRegister()
        ...
        CRecipes.MATTER_TRANSFORMER.builder()
            ...
            .CEtFactor(10.0)
            .duration(200)
            .chain(CMaterials.calcium)
            .CEtFactor(20.0)
            .chain(CMaterials.strontium)
            .CEtFactor(30.0)
            .chain(CMaterials.barium)
            .CEtFactor(50.0)
            .chain(CMaterials.lanthanum)
            .tier(8)
            .CEtFactor(10.0)
            .chain(CMaterials.cerium)
            .CEtFactor(30.0)
            .chain(CMaterials.praseodymium)
            .CEtFactor(90.0)
            .chain(CMaterials.neodymium)
            .tier(9)
            .CEtFactor(20.0)
            .chain(CMaterials.promethium)
            .tier(10)
            .CEtFactor(10.0)
            .chain(CMaterials.samarium)
            .tier(11)
            .CEtFactor(20.0)
            .chain(CMaterials.europium)
            .tier(12)
            .CEtFactor(60.0)
            .buildAndRegister()
        ...
        CRecipes.MATTER_TRANSFORMER.builder()
            ...
            .CEtFactor(90.0)
            .duration(200)
            .chain(CMaterials.cobalt)
            .tier(8)
            .CEtFactor(30.0)
            .chain(CMaterials.nickel)
            .CEtFactor(80.0)
            .chain(CMaterials.palladium)
            .tier(9)
            .CEtFactor(40.0)
            .buildAndRegister()
        ...
        CRecipes.MATTER_TRANSFORMER.builder()
            ...
            .CEtFactor(20.0)
            .duration(200)
            .chain(CMaterials.silver)
            .tier(9)
            .CEtFactor(10.0)
            .chain(CMaterials.gold)
            .tier(9)
            .CEtFactor(50.0)
            .chain(CMaterials.palladium)
            .tier(10)
            .CEtFactor(30.0)
            .chain(CMaterials.iridium)
            .tier(11)
            .CEtFactor(10.0)
            .chain(CMaterials.osmium)
            .tier(11)
            .CEtFactor(30.0)
            .chain(CMaterials.rhenium)
            .tier(12)
            .CEtFactor(10.0)
            .buildAndRegister()
        ...
        CRecipes.MATTER_TRANSFORMER.builder()
            ...
            .CEtFactor(70.0)
            .duration(200)
            .chain(CMaterials.tungsten)
            .tier(9)
            .CEtFactor(40.0)
            .chain(CMaterials.molybdenum)
            .tier(10)
            .CEtFactor(20.0)
            .chain(CMaterials.chromium)
            .tier(11)
            .CEtFactor(10.0)
            .buildAndRegister()
        ...
        CRecipes.MATTER_TRANSFORMER.builder()
            ...
            .CEtFactor(50.0)
            .duration(200)
            .chain(CMaterials.antimony)
            .tier(8)
            .CEtFactor(20.0)
            .chain(CMaterials.bismuth)
            .tier(9)
            .CEtFactor(10.0)
            .buildAndRegister()
