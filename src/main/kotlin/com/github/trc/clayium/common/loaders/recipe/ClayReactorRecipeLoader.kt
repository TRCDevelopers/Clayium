...
object ClayReactorRecipeLoader {
    fun registerRecipes() {
        ...
        registry
            ...
            .tier(12)
            .CEtFactor(90.0)
            .duration(1_000_000_000_000_000)
            .buildAndRegister()
        ...
        registry
            ...
            .input(
                ClayiumBlocks.RESONATOR.getItem(BlockCaReactorCoil.BlockType.PURE_ANTIMATTER, 16)
            )
