...
class CaInjectorMetaTileEntity(
    ...
    override val workable =
        RecipeLogicCaInjector(this, recipeRegistry, clayEnergyHolder, resonanceManager)
    ...
    companion object {
        /**
         * Required Antimatter amounts: 1->2: 1, 2->3: 2, 3->4: 2, 4->5: 3, 5->6: 4, 6->7: 5, 7->8:
         * 8, 8->9: 10, 9->10: 13, 10->11: 17, 11->12: 23, 12->13: 30
         */
