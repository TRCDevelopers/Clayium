...
class GuiClayWorkTable(playerInv: IInventory, private val tile: TileClayWorkTable) :
    GuiContainer(ContainerClayWorkTable(playerInv, tile)) {
    override fun drawGuiContainerForegroundLayer(mouseX: Int, mouseY: Int) {
        fontRenderer.drawString(I18n.format("tile.$MOD_ID.clay_work_table.name"), 6, 6, 0x404040)
    ...
    override fun drawGuiContainerBackgroundLayer(partialTicks: Float, mouseX: Int, mouseY: Int) {
        ...
        this.drawTexturedModalRect(
            ...
            176,
            0,
            tile.getCraftingProgressScaled(80),
            16
        )
