...
object MetalChestModelLoader : ICustomModelLoader {
    override fun onResourceManagerReload(resourceManager: IResourceManager) {}

    override fun accepts(modelLocation: ResourceLocation): Boolean {
        return modelLocation.namespace == MOD_ID && "metal_chest" in modelLocation.path
    }
    ...
    override fun loadModel(modelLocation: ResourceLocation): IModel {
        return object : IModel {
            ...
            override fun getTextures(): Collection<ResourceLocation> {
                return listOf(
                    clayiumId("textures/entity/metalchest/base.png"),
                    clayiumId("textures/entity/metalchest/dark.png"),
                    clayiumId("textures/entity/metalchest/light.png"),
                )
            }
