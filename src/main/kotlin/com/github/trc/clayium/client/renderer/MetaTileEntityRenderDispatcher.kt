...
object MetaTileEntityRenderDispatcher : TileEntitySpecialRenderer<MetaTileEntityHolder>() {
    override fun render(
        ...
        val laserSource =
            metaTileEntity.getCapability(ClayiumTileCapabilities.CLAY_LASER_SOURCE, null)
        ...
        if (world.getBlockState(holder.pos).getValue(BlockMachine.IS_PIPE)) {
            PipedMachineIoRenderer.renderPipeIoIcons(
                holder,
                x,
                y,
                z,
                this.rendererDispatcher.entity as? EntityPlayer ?: return,
                this::bindTexture
            )
        }
    }
