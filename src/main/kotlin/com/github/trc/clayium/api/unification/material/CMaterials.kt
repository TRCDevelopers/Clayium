...
object CMaterials {
    ...
    val actinium =
        CMaterial.create(1, clayiumId("actinium")) {
            tier(7).colors(0xF5F5F5, 0x0000EB, 0xFFFFFF)
            ingot().dust()
        }
    val aluminum =
        CMaterial.create(2, clayiumId("aluminum")) {
            tier(6)
    ...
    val americium =
        CMaterial.create(3, clayiumId("americium")) {
            tier(11).colors(0xEBEBEB, 0x9B9B9B, 0xEBEBEB)
            ingot()
        }
    val antimony =
        CMaterial.create(4, clayiumId("antimony")) {
    ...
    val barium =
        CMaterial.create(8, clayiumId("barium")) {
    ...
    val beryllium =
        CMaterial.create(10, clayiumId("beryllium")) {
    ...
    val bismuth =
        CMaterial.create(11, clayiumId("bismuth")) {
    ...
    val caesium =
        CMaterial.create(15, clayiumId("caesium")) {
            tier(8).colors(0xF5F5F5, 0x969600, 0xFFFFFF)
            ingot()
        }
    val calcium =
        CMaterial.create(16, clayiumId("calcium")) {
    ...
    val europium =
        CMaterial.create(32, clayiumId("europium")) {
    ...
    val francium =
        CMaterial.create(36, clayiumId("francium")) {
    ...
    val gold =
        CMaterial.create(40, clayiumId("gold")) {
            colors(0xFFFF0A, 0x3C3C00, 0xFFFFFF)
            dust()
        }
    val hafnium =
        CMaterial.create(41, clayiumId("hafnium")) {
    ...
    val iridium =
        CMaterial.create(48, clayiumId("iridium")) {
            tier(11).colors(0xF0F0F0, 0xD2D2D2, 0xEBEBEB)
            ingot()
        }
    val iron =
        CMaterial.create(49, clayiumId("iron")) {
    ...
    val magnesium =
        CMaterial.create(57, clayiumId("magnesium")) {
    ...
    val manganese =
        CMaterial.create(58, clayiumId("manganese")) {
    ...
    val rubidium =
        CMaterial.create(89, clayiumId("rubidium")) {
    ...
    val samarium =
        CMaterial.create(92, clayiumId("samarium")) {
    ...
    val silicon =
        CMaterial.create(96, clayiumId("silicon")) {
            tier(5)
    ...
    val silver =
        CMaterial.create(97, clayiumId("silver")) {
            tier(9).colors(0xE6E6F5, 0x78788C, 0xFFFFFF)
            ingot()
        }
    val sodium =
        CMaterial.create(98, clayiumId("sodium")) {
    ...
    val strontium =
        CMaterial.create(99, clayiumId("strontium")) {
    ...
    val sulfur =
        CMaterial.create(100, clayiumId("sulfur")) {
            tier(6).colors(0xE6E600, 0xCDCD00, 0xFFFF00)
            dust()
        }
    val tantalum =
        CMaterial.create(101, clayiumId("tantalum")) {
    ...
    val tungsten =
        CMaterial.create(111, clayiumId("tungsten")) {
            tier(9).colors(0x1E1E1E, 0x191919, 0xFFFFFF)
            ingot()
        }
    val uranium =
        CMaterial.create(112, clayiumId("uranium")) {
            tier(9).colors(0x32FF32, 0x329B32, 0x32FF32)
            ingot()
        }
    val vanadium =
        CMaterial.create(113, clayiumId("vanadium")) {
    ...
    val zinc =
        CMaterial.create(117, clayiumId("zinc")) {
    ...
    val zirconium =
        CMaterial.create(118, clayiumId("zirconium")) {
    ...
    val octupleEnergyClay: CMaterial =
        CMaterial.create(164, clayiumId("octuple_energy_clay")) {
            tier(12)
    ...
    // region Matters
    val antimatter =
        CMaterial.create(201, clayiumId("antimatter")) {
            tier(10)
    ...
    val pureAntimatter =
        CMaterial.create(202, clayiumId("pure_antimatter")) {
            tier(11)
    ...
    val pureAntimatter1 =
        CMaterial.create(203, clayiumId("pure_antimatter1")) {
            tier(11).colors(0xC42385, 0x191919, 0xFFFFFF)
            matter("matter2")
        }
    val pureAntimatter2 =
        CMaterial.create(204, clayiumId("pure_antimatter2")) {
            tier(11).colors(0x8E1777, 0x323200, 0xFFFFFF)
            matter("matter2")
        }
    val pureAntimatter3 =
        CMaterial.create(205, clayiumId("pure_antimatter3")) {
            tier(11).colors(0x5E0D45, 0x4B4B00, 0xFFFFFF)
            matter("matter3")
        }
    val pureAntimatter4 =
        CMaterial.create(206, clayiumId("pure_antimatter4")) {
            tier(12).colors(0x32061F, 0x646400, 0xFFFFFF)
            matter("matter3")
        }
    val pureAntimatter5 =
        CMaterial.create(207, clayiumId("pure_antimatter5")) {
            tier(12).colors(0x520829, 0x7D7D00, 0xFFFFFF)
            matter("matter4")
        }
    val pureAntimatter6 =
        CMaterial.create(208, clayiumId("pure_antimatter6")) {
            tier(12).colors(0x6E0727, 0x969600, 0xFFFFFF)
            matter("matter4")
        }
    val pureAntimatter7 =
        CMaterial.create(209, clayiumId("pure_antimatter7")) {
            tier(13).colors(0x840519, 0xAFAF00, 0xFFFFFF)
            matter("matter4")
        }
    val octuplePureAntimatter =
        CMaterial.create(210, clayiumId("octuple_pure_antimatter")) {
    ...
    val organicClay =
        CMaterial.create(301, clayiumId("organic_clay")) {
            tier(5)
            colors(0x8890AD, 0x6A2C2B, 0x92A4B7)
            dust()
        }
    val calciumChloride = CMaterial.create(302, clayiumId("calcium_chloride")) { dust() }
    val sodiumCarbonate = CMaterial.create(303, clayiumId("sodium_carbonate")) { dust() }
    val calcareousClay =
        CMaterial.create(304, clayiumId("calcareous_clay")) {
            tier(4)
            dust()
        }
    // endregion

    /** Materials composed of anything other than First or higher Degree Materials. 501 - 1000 */
    // region First Degree Materials
    val brass =
        CMaterial.create(501, clayiumId("brass")) {
            tier(6).colors(0xBEAA14, 0x000000, 0xFFFFFF)
            ingot().dust()
        }
    val bronze =
        CMaterial.create(502, clayiumId("bronze")) {
            tier(5).colors(0xFA9628, 0x000000, 0xFFFFFF)
            ingot().dust()
        }
    val charcoal =
        CMaterial.create(503, clayiumId("charcoal")) {
            colors(0x141414, 0x191919, 0x503232)
            dust()
        }
    val claySteel =
        CMaterial.create(504, clayiumId("clay_steel")) {
            tier(7)
    ...
    val clayium =
        CMaterial.create(505, clayiumId("clayium")) {
            tier(8)
    ...
    val coal =
        CMaterial.create(506, clayiumId("coal")) {
            colors(0x141414, 0x191919, 0x323250)
            dust()
        }
    val graphite = CMaterial.create(507, clayiumId("graphite")) {}
    val electrum =
        CMaterial.create(508, clayiumId("electrum")) {
            tier(6).colors(0xE6E69B, 0x787846, 0xFFFFFF)
            ingot().dust()
        }
    val impureGlowStone =
        CMaterial.create(509, clayiumId("impure_glowstone")) {
            colors(0x979746, 0x191919, 0xFFFFFF)
            dust()
        }
    val impureRedstone =
        CMaterial.create(510, clayiumId("impure_redstone")) {
            colors(0x974646, 0x191919, 0xFFFFFF)
            dust()
        }
    val impureSilicon =
        CMaterial.create(511, clayiumId("impure_silicon")) {
            tier(5)
    ...
    val invar =
        CMaterial.create(512, clayiumId("invar")) {
            tier(6).colors(0xAAAA50, 0x8C8C46, 0xB4B450)
            ingot().dust()
        }
    val lapis =
        CMaterial.create(513, clayiumId("lapis")) {
            colors(0x3C64BE, 0x0A2B7A, 0x5A82E2)
            dust()
        }
    val quartz =
        CMaterial.create(514, clayiumId("quartz")) {
            dust()
            blockAmount(4)
        }
    val salt =
        CMaterial.create(515, clayiumId("salt")) {
            tier(4)
            colors(0xFFFFFF, 0x8C8C8C, 0xFFFFFF)
            dust()
        }
    val saltpeter =
        CMaterial.create(516, clayiumId("saltpeter")) {
            colors(0xDEDCDC, 0xBEC8D2, 0xFFF0E6)
            dust()
        }
    val silicone =
        CMaterial.create(517, clayiumId("silicone")) {
            tier(5)
    ...
    val steel =
        CMaterial.create(518, clayiumId("steel")) {
            tier(3).colors(0x5A5A6E, 0x000000, 0xFFFFFF)
            ingot().dust()
            blastSmelting(6, 500)
        }
    val ultimateAlloy =
        CMaterial.create(519, clayiumId("ultimate_alloy")) {
            tier(9)
    ...
    val zinc_aluminum =
        CMaterial.create(520, clayiumId("zinc_aluminum")) {
            tier(6).colors(0xF0BEDC, 0xA00000, 0xFFFFFF)
            ingot().dust()
            claySmelting(0.2, 6, 400)
        }
    val zinc_zirconium =
        CMaterial.create(521, clayiumId("zinc_zirconium")) {
    ...
    val az91d =
        CMaterial.create(1001, clayiumId("az91d")) {
    ...
    val zk60a =
        CMaterial.create(1002, clayiumId("zk60a")) {
            tier(6).colors(0x4B5550, 0x0A280A, 0xFFFFFF)
            ingot().dust()
            plate(ClayEnergy.milli(1), 20, tier = 4)
            claySmelting(0.2, 6, 400)
        }
    val ultimateCompound =
        CMaterial.create(1003, clayiumId("ultimate_compound")) {
            tier(8).colors(0x55CD55, 0xF5FFFF, 0xF5A0FF)
            ingot()
        }
    // endregion

    val PURE_ANTIMATTERS =
        listOf(
            pureAntimatter,
            pureAntimatter1,
            pureAntimatter2,
    ...
    init {
        // region Clay Materials
        compressedEnergeticClay7 =
            CMaterial.create(163, clayiumId("compressed_energetic_clay7")) {
                tier(11)
        ...
        compressedEnergeticClay5 =
            CMaterial.create(161, clayiumId("compressed_energetic_clay5")) {
                tier(9)
                clay(10, compressedEnergeticClay6, ClayEnergy.of(100_000))
            }

        compressedEnergeticClay4 =
            CMaterial.create(160, clayiumId("compressed_energetic_clay4")) {
                tier(8)
                clay(9, compressedEnergeticClay5, ClayEnergy.of(10_000))
            }

        compressedEnergeticClay3 =
            CMaterial.create(159, clayiumId("compressed_energetic_clay3")) {
                tier(7)
                clay(8, compressedEnergeticClay4, ClayEnergy.of(1_000))
            }

        compressedEnergeticClay2 =
            CMaterial.create(158, clayiumId("compressed_energetic_clay2")) {
                tier(6)
                clay(7, compressedEnergeticClay3, ClayEnergy.of(100))
            }

        compressedEnergeticClay =
            CMaterial.create(157, clayiumId("compressed_energetic_clay")) {
                tier(5)
                clay(6, compressedEnergeticClay2, ClayEnergy.of(10))
            }

        energeticClay =
            CMaterial.create(156, clayiumId("energetic_clay")) {
                tier(4)
                clay(5, compressedEnergeticClay, ClayEnergy.of(1))
            }

        advancedIndustrialClay =
            CMaterial.create(155, clayiumId("advanced_industrial_clay")) {
                tier(3)
        ...
        industrialClay =
            CMaterial.create(154, clayiumId("industrial_clay")) {
                tier(2)
        ...
        compressedClay =
            CMaterial.create(153, clayiumId("compressed_clay")) {
                tier(1)
                clay(2, industrialClay)
            }

        denseClay =
            CMaterial.create(152, clayiumId("dense_clay")) {
                tier(0)
        ...
        clay =
            CMaterial.create(151, clayiumId("clay")) {
                tier(0)
                clay(0, denseClay)
                dust()
