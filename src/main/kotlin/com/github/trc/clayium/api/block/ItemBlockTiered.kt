...
open class ItemBlockTiered<T>(
...
) : ItemBlock(tieredBlock), ITieredItem where T : Block, T : ITieredBlock {
    init {
    ...
    override fun getItemStackDisplayName(stack: ItemStack): String {
        ...
        // then search for tier-less
            ...
            return I18n.format(
                translationKey,
                I18n.format(this.getTier(stack).prefixTranslationKey)
            )
        }
        // fallback to super
        else {
    ...
    override fun addInformation(
        ...
        UtilLocale.formatTooltips(
            tooltip,
            "$translationKey.${this.getTier(stack).lowerName}.tooltip"
        )
    ...
    companion object {
        fun <T> noSubTypes(tieredBlock: T) where T : Block, T : ITieredBlock =
            ItemBlockTiered(tieredBlock, false)
    }
}
