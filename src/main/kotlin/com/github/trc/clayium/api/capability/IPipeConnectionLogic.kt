...
interface IPipeConnectionLogic {
    ...
    object Machine : IPipeConnectionLogic {
        override fun canConnect(
            thisMode: PipeConnectionMode,
            neighborMode: PipeConnectionMode
        ): Boolean {
            if (thisMode == PipeConnectionMode.NONE || neighborMode == PipeConnectionMode.NONE)
                return false
            if (thisMode == PipeConnectionMode.BOTH || neighborMode == PipeConnectionMode.BOTH)
                return true
