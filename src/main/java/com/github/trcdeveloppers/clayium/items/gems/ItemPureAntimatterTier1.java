...
public class ItemPureAntimatterTier1 extends Item implements ClayiumItems.ClayiumItem, IColored {
    ...
    public IItemColor getColor() {
        return ((stack, tintIndex) -> tintIndex == 0 ? 0xC423B5 : (tintIndex == 1 ? 0x191900 : 0xFFFFFF));
    }
}