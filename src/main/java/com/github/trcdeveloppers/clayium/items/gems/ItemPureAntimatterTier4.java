...
public class ItemPureAntimatterTier4 extends Item implements ClayiumItems.ClayiumItem, IColored {
    ...
    public IItemColor getColor() {
        return ((stack, tintIndex) -> tintIndex == 0 ? 0x32061F : (tintIndex == 1 ? 0x646400 : 0xFFFFFF));
    }
}