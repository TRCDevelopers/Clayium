package io.github.trcdevelopers.clayium.metatileentity

import io.github.trcdevelopers.clayium.Bootstrap
import io.github.trcdevelopers.clayium.api.util.ClayTiers
import io.github.trcdevelopers.clayium.api.util.clayiumId
import io.github.trcdevelopers.clayium.common.metatileentities.DistributorMetaTileEntity
import io.github.trcdevelopers.clayium.util.beEmpty
import io.github.trcdevelopers.clayium.util.haveCount
import io.github.trcdevelopers.clayium.util.haveItem
...
class TestClayDistributor : StringSpec({
    ...
    "Distribute 64 items to 2 handlers" {
        ...
        distributor.distribute(source, map, Int.MAX_VALUE)
