    ...
    StringSpec({
        ...
        "IItemHandler Serialization" {
            ...
            ItemStack.areItemStacksEqual(
                newHandler.getStackInSlot(0),
                originalHandler.getStackInSlot(0)
            ) shouldBe true
            ItemStack.areItemStacksEqual(
                newHandler.getStackInSlot(1),
                originalHandler.getStackInSlot(1)
            ) shouldBe true
            newHandler.getStackInSlot(2).isEmpty shouldBe true
            newHandler.getStackInSlot(3).isEmpty shouldBe true
            ItemStack.areItemStacksEqual(
                newHandler.getStackInSlot(4),
                originalHandler.getStackInSlot(4)
            ) shouldBe true
        }
    })
